...
// To hold datatype into very fexible point
...
int main(){
    ...
    //********************** Read the cloud
    std::string path = "/home/rohit/pcl_ws/src/ROS2-Point-Cloud-Clustering-and-Segmentation-for-Autonomous-Behaviour/point_cloud_processing/point_clouds/";
    std::string cloud_name = "tb3_world_.pcd";
    ...
    // // Cloud writing
    // cloud_writer.write<PointT>(path+output_name,*passthrough_cloud);
    // Writing cloud
